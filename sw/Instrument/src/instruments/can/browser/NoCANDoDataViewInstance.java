 ...
 * Module:   NoCANDo data view instance managing class
 * Version:  0.1
 * Licence:  GPL2
 *
 * Owner: Kim Kristo
...
public class NoCANDoDataViewInstance extends InstanceBase {      
    private MessageInterface msg;
    
            
    /** Creates new form HP3480Instance */
    public NoCANDoDataViewInstance(String name, Hashtable<String, String>properties, 
            DesktopInterface desktop, MessageInterface msg) {
        // get logger instance for this class
        logger = Logger.getLogger(NoCANDoDataViewInstance.class);
        ...
        device = new NoCANDoDataView(name, properties, msg);
